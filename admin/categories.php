            ...
            <?php 
                ...
                if (isset($_POST['add-new-cat'])) {
                    ...
                    if (empty($cat_title)) {
                        ...
                        $sqla = "INSERT INTO categories (cat_title) VALUES (:catt)";
            ...
            <?php 
                ...
                if (isset($_POST['update-cat'])) {
                    ...
                    if (empty($cat_t)) {
                        ...
                        $sqlu = "UPDATE categories SET cat_title = :title WHERE cat_id = :catid";
                    ...
                    <form action="categories.php" method="POST" class="py-4">
                        <div class="row">
                            <div class="col">
                                ...
                                <input name="cat-t" type="text" class="form-control" value="<?php echo $tit; ?>">
                            </div>
                            <div class="col">
                                <input name="update-cat" type="submit" class="form-control btn btn-primary" value="Upadate Category">
                            </div>
                        </div>
                    </form>
                <?php }
